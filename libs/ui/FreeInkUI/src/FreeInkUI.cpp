...
// Classic geometry shares unchanged keys with the upstream layouts.
static const KeyboardKey CLASSIC_EN_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2), K("z", "z", 'z'),
                                      K("x", "x", 'x'), K("c", "c", 'c'), K("v", "v", 'v'), K("b", "b", 'b'),
                                      K("n", "n", 'n'), K("m", "m", 'm'),
                                      KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_EN_ROW4[] = {KS("?123", KeyKind::Mode, QWERTY_KEY_MODE, 2),
                                      KS("Space", KeyKind::Space, QWERTY_KEY_SPACE, 6),
                                      KS("OK", KeyKind::Ok, QWERTY_KEY_ENTER, 2)};
static const KeyboardKey CLASSIC_EN_SHIFT_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2), K("Z", "Z", 'Z'),
                                            K("X", "X", 'X'), K("C", "C", 'C'), K("V", "V", 'V'), K("B", "B", 'B'),
                                            K("N", "N", 'N'), K("M", "M", 'M'),
                                            KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_SYMBOL_ROW3[] = {KS("#+=", KeyKind::Shift, QWERTY_KEY_SHIFT, 2), K(".", ".", '.'),
                                          K(",", ",", ','), K("?", "?", '?'), K("!", "!", '!'), K("'", "'", '\''),
                                          K("\"", "\"", '"'), K("#", "#", '#'),
                                          KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_SYMBOL_ROW4[] = {KS("ABC", KeyKind::Mode, QWERTY_KEY_MODE, 2),
                                          KS("Space", KeyKind::Space, QWERTY_KEY_SPACE, 6),
                                          KS("OK", KeyKind::Ok, QWERTY_KEY_ENTER, 2)};
static const KeyboardKey CLASSIC_SYMBOL2_ROW3[] = {KS("123", KeyKind::Shift, QWERTY_KEY_SHIFT, 2), K(".", ".", '.'),
                                           K(",", ",", ','), K("?", "?", '?'), K("!", "!", '!'), K("'", "'", '\''),
                                           K("\"", "\"", '"'), K("#", "#", '#'),
                                           KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_FR_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2), K("w", "w", 'w'),
                                      K("x", "x", 'x'), K("c", "c", 'c'), K("v", "v", 'v'), K("b", "b", 'b'),
                                      K("n", "n", 'n'), K("é", "é", 1001),
                                      KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_DE_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2), K("y", "y", 'y'),
                                      K("x", "x", 'x'), K("c", "c", 'c'), K("v", "v", 'v'), K("b", "b", 'b'),
                                      K("n", "n", 'n'), K("m", "m", 'm'), K("ß", "ß", 1102),
                                      KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_ES_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2), K("z", "z", 'z'),
                                      ...
                                      K("n", "n", 'n'), K("m", "m", 'm'),
                                      KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_RU_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2),
                                      K("я", "я", 0x44F),
                                      K("ч", "ч", 0x447),
                                      K("с", "с", 0x441),
                                      K("м", "м", 0x43C),
                                      ...
                                      K("ю", "ю", 0x44E),
                                      KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_RU_SHIFT_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2),
                                            K("Я", "Я", 0x42F),
                                            K("Ч", "Ч", 0x427),
                                            K("С", "С", 0x421),
                                            K("М", "М", 0x41C),
                                            ...
                                            K("Ю", "Ю", 0x42E),
                                            KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_FR_SHIFT_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2), K("W", "W", 'W'),
                                            K("X", "X", 'X'), K("C", "C", 'C'), K("V", "V", 'V'), K("B", "B", 'B'),
                                            K("N", "N", 'N'), K("É", "É", 1051),
                                            KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_DE_SHIFT_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2), K("Y", "Y", 'Y'),
                                            K("X", "X", 'X'), K("C", "C", 'C'), K("V", "V", 'V'), K("B", "B", 'B'),
                                            K("N", "N", 'N'), K("M", "M", 'M'), K("ß", "ß", 1102),
                                            KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_ES_SHIFT_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2), K("Z", "Z", 'Z'),
                                            K("X", "X", 'X'), K("C", "C", 'C'), K("V", "V", 'V'), K("B", "B", 'B'),
                                            K("N", "N", 'N'), K("M", "M", 'M'),
                                            KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_UK_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2),
                                      K("я", "я", 0x44F),
                                      K("ч", "ч", 0x447),
                                      K("с", "с", 0x441),
                                      K("м", "м", 0x43C),
                                      ...
                                      K("ю", "ю", 0x44E),
                                      KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_UK_SHIFT_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2),
                                            K("Я", "Я", 0x42F),
                                            K("Ч", "Ч", 0x427),
                                            K("С", "С", 0x421),
                                            K("М", "М", 0x41C),
                                            ...
                                            K("Ю", "Ю", 0x42E),
                                            KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_BE_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2),
                                      K("я", "я", 0x44F),
                                      K("ч", "ч", 0x447),
                                      K("с", "с", 0x441),
                                      K("м", "м", 0x43C),
                                      ...
                                      K("ю", "ю", 0x44E),
                                      KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_BE_SHIFT_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2),
                                            K("Я", "Я", 0x42F),
                                            K("Ч", "Ч", 0x427),
                                            K("С", "С", 0x421),
                                            K("М", "М", 0x41C),
                                            ...
                                            K("Ю", "Ю", 0x42E),
                                            KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_KK_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2),
                                      K("я", "я", 0x44F),
                                      K("ч", "ч", 0x447),
                                      K("с", "с", 0x441),
                                      K("м", "м", 0x43C),
                                      ...
                                      K("ю", "ю", 0x44E),
                                      KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_KK_SHIFT_ROW3[] = {KS("Shift", KeyKind::Shift, QWERTY_KEY_SHIFT, 2),
                                            K("Я", "Я", 0x42F),
                                            K("Ч", "Ч", 0x427),
                                            K("С", "С", 0x421),
                                            K("М", "М", 0x41C),
                                            ...
                                            K("Ю", "Ю", 0x42E),
                                            KS("Del", KeyKind::Delete, QWERTY_KEY_BACKSPACE, 2)};
static const KeyboardKey CLASSIC_LANG_ROW4[] = {KS("?123", KeyKind::Mode, QWERTY_KEY_MODE, 2),
                                        KS(nullptr, KeyKind::Lang, QWERTY_KEY_LANG, 1),
                                        KS("Space", KeyKind::Space, QWERTY_KEY_SPACE, 5),
                                        KS("OK", KeyKind::Ok, QWERTY_KEY_ENTER, 2)};
static const KeyboardRow CLASSIC_EN_ROWS[] = {{EN_ROW1, 10, 0}, {EN_ROW2, 9, 1}, {CLASSIC_EN_ROW3, 9, 0}, {CLASSIC_EN_ROW4, 3, 0}};
static const KeyboardRow CLASSIC_EN_SHIFT_ROWS[] = {{EN_SHIFT_ROW1, 10, 0}, {EN_SHIFT_ROW2, 9, 1}, {CLASSIC_EN_SHIFT_ROW3, 9, 0},
                                           {CLASSIC_EN_ROW4, 3, 0}};
static const KeyboardRow CLASSIC_SYMBOL_ROWS[] = {{SYMBOL_ROW1, 10, 0}, {SYMBOL_ROW2, 9, 1}, {CLASSIC_SYMBOL_ROW3, 9, 0},
                                         {CLASSIC_SYMBOL_ROW4, 3, 0}};
static const KeyboardRow CLASSIC_SYMBOL2_ROWS[] = {{SYMBOL2_ROW1, 10, 0}, {SYMBOL2_ROW2, 6, 2}, {CLASSIC_SYMBOL2_ROW3, 9, 0},
                                          {CLASSIC_SYMBOL_ROW4, 3, 0}};
...
static const KeyboardLayout CLASSIC_SYMBOL2_LAYOUT{CLASSIC_SYMBOL2_ROWS, 4};
static const KeyboardLayout CLASSIC_FR_LAYOUT{CLASSIC_FR_ROWS, 4};
static const KeyboardLayout CLASSIC_DE_LAYOUT{CLASSIC_DE_ROWS, 4};
static const KeyboardLayout CLASSIC_ES_LAYOUT{CLASSIC_ES_ROWS, 4};
static const KeyboardRow CLASSIC_EN_NUM_ROWS[] = {{NUM_ROW, 10, 0}, {EN_ROW1, 10, 0}, {EN_ROW2, 9, 1}, {CLASSIC_EN_ROW3, 9, 0},
                                          {CLASSIC_EN_ROW4, 3, 0}};
static const KeyboardRow CLASSIC_EN_SHIFT_NUM_ROWS[] = {{NUM_SHIFT_ROW, 10, 0}, {EN_SHIFT_ROW1, 10, 0}, {EN_SHIFT_ROW2, 9, 1},
                                                {CLASSIC_EN_SHIFT_ROW3, 9, 0},  {CLASSIC_EN_ROW4, 3, 0}};
static const KeyboardRow CLASSIC_FR_NUM_ROWS[] = {{NUM_ROW, 10, 0}, {FR_ROW1, 10, 0}, {FR_ROW2, 10, 0}, {CLASSIC_FR_ROW3, 9, 0},
                                          {CLASSIC_EN_ROW4, 3, 0}};
...
static const KeyboardLayout CLASSIC_FR_NUM_LAYOUT{CLASSIC_FR_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_DE_NUM_LAYOUT{CLASSIC_DE_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_ES_NUM_LAYOUT{CLASSIC_ES_NUM_ROWS, 5};
static const KeyboardRow CLASSIC_RU_ROWS[] = {{RU_ROW1, 12, 0}, {RU_ROW2, 11, 0}, {CLASSIC_RU_ROW3, 11, 0}, {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_RU_SHIFT_ROWS[] = {{RU_SHIFT_ROW1, 12, 0},
                                            {RU_SHIFT_ROW2, 11, 0},
                                            {CLASSIC_RU_SHIFT_ROW3, 11, 0},
                                            {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_RU_NUM_ROWS[] = {{NUM_ROW, 10, 0},
                                          {RU_ROW1, 12, 0},
                                          {RU_ROW2, 11, 0},
                                          {CLASSIC_RU_ROW3, 11, 0},
                                          {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_RU_SHIFT_NUM_ROWS[] = {{NUM_SHIFT_ROW, 10, 0},
                                                {RU_SHIFT_ROW1, 12, 0},
                                                {RU_SHIFT_ROW2, 11, 0},
                                                {CLASSIC_RU_SHIFT_ROW3, 11, 0},
                                                {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_UK_ROWS[] = {
    {UK_ROW1, 12, 0}, {UK_ROW2, 11, 0}, {CLASSIC_UK_ROW3, 11, 0}, {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_UK_SHIFT_ROWS[] = {{UK_SHIFT_ROW1, 12, 0},
                                            {UK_SHIFT_ROW2, 11, 0},
                                            {CLASSIC_UK_SHIFT_ROW3, 11, 0},
                                            {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_UK_NUM_ROWS[] = {{NUM_ROW, 10, 0},
                                          {UK_ROW1, 12, 0},
                                          {UK_ROW2, 11, 0},
                                          {CLASSIC_UK_ROW3, 11, 0},
                                          {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_UK_SHIFT_NUM_ROWS[] = {{NUM_SHIFT_ROW, 10, 0},
                                                {UK_SHIFT_ROW1, 12, 0},
                                                {UK_SHIFT_ROW2, 11, 0},
                                                {CLASSIC_UK_SHIFT_ROW3, 11, 0},
                                                {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_BE_ROWS[] = {
    {BE_ROW1, 12, 0}, {BE_ROW2, 11, 0}, {CLASSIC_BE_ROW3, 11, 0}, {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_BE_SHIFT_ROWS[] = {{BE_SHIFT_ROW1, 12, 0},
                                            {BE_SHIFT_ROW2, 11, 0},
                                            {CLASSIC_BE_SHIFT_ROW3, 11, 0},
                                            {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_BE_NUM_ROWS[] = {{NUM_ROW, 10, 0},
                                          {BE_ROW1, 12, 0},
                                          {BE_ROW2, 11, 0},
                                          {CLASSIC_BE_ROW3, 11, 0},
                                          {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_BE_SHIFT_NUM_ROWS[] = {{NUM_SHIFT_ROW, 10, 0},
                                                {BE_SHIFT_ROW1, 12, 0},
                                                {BE_SHIFT_ROW2, 11, 0},
                                                {CLASSIC_BE_SHIFT_ROW3, 11, 0},
                                                {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_KK_ROWS[] = {
    {KK_ROW1, 12, 0}, {KK_ROW2, 11, 0}, {CLASSIC_KK_ROW3, 11, 0}, {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_KK_SHIFT_ROWS[] = {{KK_SHIFT_ROW1, 12, 0},
                                            {KK_SHIFT_ROW2, 11, 0},
                                            {CLASSIC_KK_SHIFT_ROW3, 11, 0},
                                            {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_KK_NUM_ROWS[] = {{NUM_ROW, 10, 0},
                                          {KK_ROW1, 12, 0},
                                          {KK_ROW2, 11, 0},
                                          {CLASSIC_KK_ROW3, 11, 0},
                                          {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_KK_SHIFT_NUM_ROWS[] = {{NUM_SHIFT_ROW, 10, 0},
                                                {KK_SHIFT_ROW1, 12, 0},
                                                {KK_SHIFT_ROW2, 11, 0},
                                                {CLASSIC_KK_SHIFT_ROW3, 11, 0},
                                                {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_HE_ROWS[] = {
    {HE_ROW1, 10, 0}, {HE_ROW2, 9, 1}, {HE_ROW3, 10, 0}, {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_HE_NUM_ROWS[] = {{NUM_ROW, 10, 0},
                                          {HE_ROW1, 10, 0},
                                          {HE_ROW2, 9, 1},
                                          {HE_ROW3, 10, 0},
                                          {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_FR_LANG_ROWS[] = {{FR_ROW1, 10, 0}, {FR_ROW2, 10, 0}, {CLASSIC_FR_ROW3, 9, 0}, {CLASSIC_LANG_ROW4, 4, 0}};
...
static const KeyboardRow CLASSIC_FR_SHIFT_LANG_NUM_ROWS[] = {{NUM_SHIFT_ROW, 10, 0}, {FR_SHIFT_ROW1, 10, 0}, {FR_SHIFT_ROW2, 10, 0}, {CLASSIC_FR_SHIFT_ROW3, 9, 0}, {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_DE_SHIFT_ROWS[] = {{DE_SHIFT_ROW1, 10, 0}, {DE_SHIFT_ROW2, 10, 0}, {CLASSIC_DE_SHIFT_ROW3, 10, 0}, {CLASSIC_EN_ROW4, 3, 0}};
...
static const KeyboardRow CLASSIC_EN_SHIFT_LANG_ROWS[] = {{EN_SHIFT_ROW1, 10, 0},
                                                 {EN_SHIFT_ROW2, 9, 1},
                                                 {CLASSIC_EN_SHIFT_ROW3, 9, 0},
                                                 {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_EN_LANG_NUM_ROWS[] = {{NUM_ROW, 10, 0},
                                               {EN_ROW1, 10, 0},
                                               {EN_ROW2, 9, 1},
                                               {CLASSIC_EN_ROW3, 9, 0},
                                               {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardRow CLASSIC_EN_SHIFT_LANG_NUM_ROWS[] = {{NUM_SHIFT_ROW, 10, 0},
                                                     {EN_SHIFT_ROW1, 10, 0},
                                                     {EN_SHIFT_ROW2, 9, 1},
                                                     {CLASSIC_EN_SHIFT_ROW3, 9, 0},
                                                     {CLASSIC_LANG_ROW4, 4, 0}};
static const KeyboardLayout CLASSIC_RU_LAYOUT{CLASSIC_RU_ROWS, 4};
static const KeyboardLayout CLASSIC_RU_SHIFT_LAYOUT{CLASSIC_RU_SHIFT_ROWS, 4};
static const KeyboardLayout CLASSIC_RU_NUM_LAYOUT{CLASSIC_RU_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_RU_SHIFT_NUM_LAYOUT{CLASSIC_RU_SHIFT_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_UK_LAYOUT{CLASSIC_UK_ROWS, 4};
static const KeyboardLayout CLASSIC_UK_SHIFT_LAYOUT{CLASSIC_UK_SHIFT_ROWS, 4};
static const KeyboardLayout CLASSIC_UK_NUM_LAYOUT{CLASSIC_UK_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_UK_SHIFT_NUM_LAYOUT{CLASSIC_UK_SHIFT_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_BE_LAYOUT{CLASSIC_BE_ROWS, 4};
static const KeyboardLayout CLASSIC_BE_SHIFT_LAYOUT{CLASSIC_BE_SHIFT_ROWS, 4};
static const KeyboardLayout CLASSIC_BE_NUM_LAYOUT{CLASSIC_BE_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_BE_SHIFT_NUM_LAYOUT{CLASSIC_BE_SHIFT_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_KK_LAYOUT{CLASSIC_KK_ROWS, 4};
static const KeyboardLayout CLASSIC_KK_SHIFT_LAYOUT{CLASSIC_KK_SHIFT_ROWS, 4};
static const KeyboardLayout CLASSIC_KK_NUM_LAYOUT{CLASSIC_KK_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_KK_SHIFT_NUM_LAYOUT{CLASSIC_KK_SHIFT_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_HE_LAYOUT{CLASSIC_HE_ROWS, 4};
static const KeyboardLayout CLASSIC_HE_NUM_LAYOUT{CLASSIC_HE_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_FR_LANG_LAYOUT{CLASSIC_FR_LANG_ROWS, 4};
static const KeyboardLayout CLASSIC_FR_LANG_NUM_LAYOUT{CLASSIC_FR_LANG_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_DE_LANG_LAYOUT{CLASSIC_DE_LANG_ROWS, 4};
static const KeyboardLayout CLASSIC_DE_LANG_NUM_LAYOUT{CLASSIC_DE_LANG_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_ES_LANG_LAYOUT{CLASSIC_ES_LANG_ROWS, 4};
static const KeyboardLayout CLASSIC_ES_LANG_NUM_LAYOUT{CLASSIC_ES_LANG_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_FR_SHIFT_LAYOUT{CLASSIC_FR_SHIFT_ROWS, 4};
static const KeyboardLayout CLASSIC_FR_SHIFT_NUM_LAYOUT{CLASSIC_FR_SHIFT_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_FR_SHIFT_LANG_LAYOUT{CLASSIC_FR_SHIFT_LANG_ROWS, 4};
static const KeyboardLayout CLASSIC_FR_SHIFT_LANG_NUM_LAYOUT{CLASSIC_FR_SHIFT_LANG_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_DE_SHIFT_LAYOUT{CLASSIC_DE_SHIFT_ROWS, 4};
static const KeyboardLayout CLASSIC_DE_SHIFT_NUM_LAYOUT{CLASSIC_DE_SHIFT_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_DE_SHIFT_LANG_LAYOUT{CLASSIC_DE_SHIFT_LANG_ROWS, 4};
static const KeyboardLayout CLASSIC_DE_SHIFT_LANG_NUM_LAYOUT{CLASSIC_DE_SHIFT_LANG_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_ES_SHIFT_LAYOUT{CLASSIC_ES_SHIFT_ROWS, 4};
static const KeyboardLayout CLASSIC_ES_SHIFT_NUM_LAYOUT{CLASSIC_ES_SHIFT_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_ES_SHIFT_LANG_LAYOUT{CLASSIC_ES_SHIFT_LANG_ROWS, 4};
static const KeyboardLayout CLASSIC_ES_SHIFT_LANG_NUM_LAYOUT{CLASSIC_ES_SHIFT_LANG_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_EN_LANG_LAYOUT{CLASSIC_EN_LANG_ROWS, 4};
static const KeyboardLayout CLASSIC_EN_SHIFT_LANG_LAYOUT{CLASSIC_EN_SHIFT_LANG_ROWS, 4};
static const KeyboardLayout CLASSIC_EN_LANG_NUM_LAYOUT{CLASSIC_EN_LANG_NUM_ROWS, 5};
static const KeyboardLayout CLASSIC_EN_SHIFT_LANG_NUM_LAYOUT{CLASSIC_EN_SHIFT_LANG_NUM_ROWS, 5};
...
static const KeyboardLayout& classicBuiltinKeyboardLayout(KeyboardLayoutId id, bool shifted, bool symbols, bool numberRow,
                                            bool langKey) {
  ...
  // letter layers.
  if (symbols) return shifted ? CLASSIC_SYMBOL2_LAYOUT : CLASSIC_SYMBOL_LAYOUT;
  ...
  if (id == KeyboardLayoutId::CyrillicRu) {
    if (shifted) return numberRow ? CLASSIC_RU_SHIFT_NUM_LAYOUT : CLASSIC_RU_SHIFT_LAYOUT;
    return numberRow ? CLASSIC_RU_NUM_LAYOUT : CLASSIC_RU_LAYOUT;
  }
  if (id == KeyboardLayoutId::CyrillicUk) {
    if (shifted) return numberRow ? CLASSIC_UK_SHIFT_NUM_LAYOUT : CLASSIC_UK_SHIFT_LAYOUT;
    return numberRow ? CLASSIC_UK_NUM_LAYOUT : CLASSIC_UK_LAYOUT;
  }
  if (id == KeyboardLayoutId::CyrillicBe) {
    if (shifted) return numberRow ? CLASSIC_BE_SHIFT_NUM_LAYOUT : CLASSIC_BE_SHIFT_LAYOUT;
    return numberRow ? CLASSIC_BE_NUM_LAYOUT : CLASSIC_BE_LAYOUT;
  }
  if (id == KeyboardLayoutId::CyrillicKk) {
    if (shifted) return numberRow ? CLASSIC_KK_SHIFT_NUM_LAYOUT : CLASSIC_KK_SHIFT_LAYOUT;
    return numberRow ? CLASSIC_KK_NUM_LAYOUT : CLASSIC_KK_LAYOUT;
  }
  // Hebrew has no case, so shift is ignored -- there is only one letter layer.
  if (id == KeyboardLayoutId::HebrewIl) return numberRow ? CLASSIC_HE_NUM_LAYOUT : CLASSIC_HE_LAYOUT;
  if (id == KeyboardLayoutId::QwertyEn && langKey) {
    if (shifted) return numberRow ? CLASSIC_EN_SHIFT_LANG_NUM_LAYOUT : CLASSIC_EN_SHIFT_LANG_LAYOUT;
    return numberRow ? CLASSIC_EN_LANG_NUM_LAYOUT : CLASSIC_EN_LANG_LAYOUT;
  }
  if (shifted && id == KeyboardLayoutId::QwertyEn) return numberRow ? CLASSIC_EN_SHIFT_NUM_LAYOUT : CLASSIC_EN_SHIFT_LAYOUT;
  switch (id) {
    case KeyboardLayoutId::AzertyFr:
      if (shifted && langKey) return numberRow ? CLASSIC_FR_SHIFT_LANG_NUM_LAYOUT : CLASSIC_FR_SHIFT_LANG_LAYOUT;
      if (shifted) return numberRow ? CLASSIC_FR_SHIFT_NUM_LAYOUT : CLASSIC_FR_SHIFT_LAYOUT;
      if (langKey) return numberRow ? CLASSIC_FR_LANG_NUM_LAYOUT : CLASSIC_FR_LANG_LAYOUT;
      return numberRow ? CLASSIC_FR_NUM_LAYOUT : CLASSIC_FR_LAYOUT;
    case KeyboardLayoutId::QwertzDe:
      if (shifted && langKey) return numberRow ? CLASSIC_DE_SHIFT_LANG_NUM_LAYOUT : CLASSIC_DE_SHIFT_LANG_LAYOUT;
      if (shifted) return numberRow ? CLASSIC_DE_SHIFT_NUM_LAYOUT : CLASSIC_DE_SHIFT_LAYOUT;
      if (langKey) return numberRow ? CLASSIC_DE_LANG_NUM_LAYOUT : CLASSIC_DE_LANG_LAYOUT;
      return numberRow ? CLASSIC_DE_NUM_LAYOUT : CLASSIC_DE_LAYOUT;
    case KeyboardLayoutId::SpanishEs:
      if (shifted && langKey) return numberRow ? CLASSIC_ES_SHIFT_LANG_NUM_LAYOUT : CLASSIC_ES_SHIFT_LANG_LAYOUT;
      if (shifted) return numberRow ? CLASSIC_ES_SHIFT_NUM_LAYOUT : CLASSIC_ES_SHIFT_LAYOUT;
      if (langKey) return numberRow ? CLASSIC_ES_LANG_NUM_LAYOUT : CLASSIC_ES_LANG_LAYOUT;
      return numberRow ? CLASSIC_ES_NUM_LAYOUT : CLASSIC_ES_LAYOUT;
    case KeyboardLayoutId::QwertyEn:
    default:
      return numberRow ? CLASSIC_EN_NUM_LAYOUT : CLASSIC_EN_LAYOUT;
  }
}

const KeyboardLayout& builtinKeyboardLayout(KeyboardLayoutId id, bool shifted, bool symbols, bool numberRow,
                                            bool langKey, KeyboardGeometry geometry) {
  if (geometry == KeyboardGeometry::Classic && id != KeyboardLayoutId::ArabicAr)
    return classicBuiltinKeyboardLayout(id, shifted, symbols, numberRow, langKey);
  // In the symbols layers `shifted` selects the second page: the shift slot
  // reads "#+=" on page one and "123" on page two, mirroring phone keyboards.
  // The symbols pages already carry digits, so numberRow only affects the
  // letter layers.
