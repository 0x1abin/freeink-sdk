...
// --- 2) Coherence: exactly one MCU family, at least one device ---------------
      ...
      FREEINK_DEVICE_ONEPAGE || FREEINK_DEVICE_METALIO_EINK4 || FREEINK_DEVICE_WS397)
#error \
    "FreeInk: no device selected. Pass at least one -DFREEINK_DEVICE_<NAME> (X4, X3, X4PRO, X4CLASSIC, M5, MURPHY, DELINK, LILYGO, M5PAPER, STICKY, PAPERMONO, PAPERS3, MURPHY_M4, EEGO_A4, WAVESHARE_EPAPER_397, METALIO_EINK4, ONEPAGE, WS397) in your build env — see platformio.sample.ini."
#endif
...
#define FREEINK_MCU_S3                                                                                      \
  (FREEINK_DEVICE_M5 || FREEINK_DEVICE_MURPHY || FREEINK_DEVICE_DELINK || FREEINK_DEVICE_LILYGO ||          \
   ...
   FREEINK_DEVICE_WAVESHARE_EPAPER_397 || FREEINK_DEVICE_METALIO_EINK4 || FREEINK_DEVICE_WS397)
...
#endif
#ifndef FREEINK_STICKY_COMBINED_AA
#define FREEINK_STICKY_COMBINED_AA 0
#endif
#if FREEINK_STICKY_COMBINED_AA && !FREEINK_DEVICE_STICKY
#error "FREEINK_STICKY_COMBINED_AA requires the Sticky board profile"
#endif
#if FREEINK_DEVICE_PAPERMONO || FREEINK_STICKY_COMBINED_AA
...
#define FREEINK_BATTERY_I2C_GAUGE                                                                 \
  (FREEINK_DEVICE_X3 || FREEINK_DEVICE_LILYGO || FREEINK_DEVICE_STICKY || FREEINK_DEVICE_X4PRO || \
   FREEINK_DEVICE_X4CLASSIC || FREEINK_DEVICE_METALIO_EINK4 || FREEINK_DEVICE_WS397)
#endif
...
#define FREEINK_CAP_RTC                                                                                        \
  (FREEINK_DEVICE_X3 || FREEINK_DEVICE_STICKY || FREEINK_DEVICE_X4PRO || FREEINK_DEVICE_X4CLASSIC ||           \
   ...
   FREEINK_DEVICE_WAVESHARE_EPAPER_397 || FREEINK_DEVICE_LILYGO || FREEINK_DEVICE_METALIO_EINK4 || FREEINK_DEVICE_WS397)
#endif
...
#define FREEINK_SD_SDMMC                                                                                    \
  (FREEINK_DEVICE_DELINK || FREEINK_DEVICE_X4PRO || FREEINK_DEVICE_X4CLASSIC || FREEINK_DEVICE_PAPERMONO || \
   FREEINK_DEVICE_MURPHY_M4 || FREEINK_DEVICE_WAVESHARE_EPAPER_397 || FREEINK_DEVICE_METALIO_EINK4 || FREEINK_DEVICE_WS397)
#endif
...
constexpr uint32_t MAX_FRAMEBUFFER_BYTES = cmax(cmax(cmax(cmax(FREEINK_DEVICE_X4 ? panelBytes(XTEINK_X4) : 0u, FREEINK_DEVICE_X3 ? panelBytes(XTEINK_X3) : 0u),
